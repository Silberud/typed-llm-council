...
This project critiques and benchmarks the outputs of named third-party LLMs (Claude, Gemini, GPT, Qwen, Grok, Kimi). Substantive technical criticism of model behaviour, prompts, or training is encouraged and is **not** considered harassment. Vendor or fan-tribalism (dismissing contributors based on which model they prefer) **is** out of bounds.
...
This Code of Conduct applies within all community spaces (issue tracker, discussions, pull requests, code comments) and also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the project maintainer at **igor.silberud@gmail.com**.
